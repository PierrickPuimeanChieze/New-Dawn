 ...
 */
public final class MyFilteredList<E> extends TransformationList<E, E>
    ...
    private void update(int paramInt1, List<? extends E> paramList, int[] paramArrayOfInt, int paramInt2) {
        ...
        fireChange(new NonIterableChange.GenericAddRemoveChange(i, i + paramInt2, Collections.
                unmodifiableList(localArrayList), this));
    }

    public MyFilteredList(List<E> paramList, Matcher<? super E> paramMatcher, FilterableList.FilterMode paramFilterMode) {
        super(paramList);
    ...
    protected void onSourceChanged(ListChangeListener.Change<? extends E> paramChange) {
        while (paramChange.next()) {
            ...
            if (this.mode == FilterableList.FilterMode.BATCH) {
                ...
                update(paramChange.getFrom(), paramChange.getRemoved(), arrayOfInt1, arrayOfInt1.length);
            } else {
                ...
                update(paramChange.getFrom(), paramChange.getRemoved(), arrayOfInt2, i);
            }
        }
    }
    ...
    public int indexOf(Object paramObject) {
        for (int i = 0; i < size(); i++) {
            if (((paramObject == null) && (get(i) == null)) || ((paramObject != null) && (paramObject.
                    equals(get(i))))) {
                return i;
            }
        }
    ...
    private void refilter() {
        ...
        fireChange(new NonIterableChange.GenericAddRemoveChange(0, this.size, localArrayList, this));
    }
    ...
    public void filter() {
        if (this.mode == FilterableList.FilterMode.BATCH) {
            ...
            fireChange(new NonIterableChange.GenericAddRemoveChange(i, j, Collections.
                    unmodifiableList(localArrayList), this));
        }
    }
