...
//       .addL
    ...
    public DoubleProperty minimalRadiusProperty() {
        if (minimalRadiusProperty == null) {
            minimalRadiusProperty = new SimpleDoubleProperty(this, "minimalRadiusProperty", 5);
        }
     ...
     *
     * @param minimalRadius new value of minimalRadius
     */
    ...
    public void update() {
        ...
        double radiusToSet = (body.getDiameter() / 2.0 / Constants.FIXED_QUOTIENT) * zoomLevel;
