...
public class MainController {
    ...
    public void setShipMovementController(ShipMovementController shipMovementController) {
     ...
     *
     * @param celestialBodyMovementControlelr new value of
     * celestialBodyMovementControlelr
     */
    public void setCelestialBodyMovementController(CelestialBodyMovementController celestialBodyMovementController) {
     ...
     *
     * @param gameData new value of gameData
     */
    ...
    public final void runIncrements(long totalLength) {
        ...
        if (totalLength < subPulse) {
            throw new IllegalArgumentException("Total Length inferior to the selected Sub pulse");
        }

        if (totalLength % subPulse != 0) {
            throw new IllegalArgumentException("Total Length not dividable by the selected Sub Pulse");
        }
